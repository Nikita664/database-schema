...
if (!isset($_SESSION['is_login'])) {
    if (isset($_REQUEST['uEmail'])) {
        ...
        $sql = "SELECT u_email, u_password FROM userlogin_tb WHERE u_email = '" . $uEmail . "' AND u_password = '" . $uPassword . "' limit 1";
...
<body>
    <div class="mb-3 text-center mt-5" style="font-size: 30px;">
        ...
        <span>User Service Managment System</span>
    </div>
        ...
        <div class="row justify-content-center custom-margin">
            <div class="col-sm-6 col-md-4">
                <form action="" class="shadow-lg p-4" method="POST">
                    ...
                    <div class="form-group">
                        <i class="fas fa-key"></i><label for="pass" class="pl-2 font-weight-bold">Password</label><input type="password" class="form-control" placeholder="Password" name="uPassword">
                    </div>
